...
import com.joanna.staybooking.exception.InvalidSearchDateException;
import com.joanna.staybooking.model.Stay;
import com.joanna.staybooking.service.SearchService;
...
public class SearchController {
    ...
    public List<Stay> searchStays(
            @RequestParam(name = "guest_number") int guestNumber,  //@RequestParam:从request里拿值
